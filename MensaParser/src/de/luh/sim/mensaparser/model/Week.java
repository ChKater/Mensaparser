...
/**
 * Enum für die Woche. Es können Gerichte der Aktuellen oder Nächsten Woche
 * angezeigt werden.
 *
 */
public enum Week {
	...
	/**
	 * Gibt die Woche anhand des Namens zurück. Wenn keine Übereinstimmung
	 * gefunden wird, wird THIS zurückgegeben.
	 * 
	 * @param name
	 *            Name der Woche (Aktuelle oder Naechste)
	 * @return Woche
	 */
